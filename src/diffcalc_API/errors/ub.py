...
class Codes(ErrorCodes):
    INVALID_SET_LATTICE_PARAMS_ERROR = 400
    REFERENCE_RETRIEVAL_ERROR = 403
    INVALID_PROPERTY_ERROR = 400
...
class InvalidSetLatticeParamsError(DiffcalcAPIException):
    def __init__(self):
        ...
        self.status_code = Codes.INVALID_SET_LATTICE_PARAMS_ERROR
